 ...
 * Generated at: 2016-01-01 04:05:24 UTC
...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/pages/core/include.jsp", Long.valueOf(1451611524154L));
  }
...
return;
    ...
    try {
      ...
      out.write("                    </label>\n");
      out.write("                </div>\n");
      out.write("                <button class=\"btn btn-lg btn-primary btn-block btn-signin\" type=\"submit\" onclick=\"verifyUser();\">Sign in</button>\n");
      out.write("            </form><!-- /form -->\n");
      ...
      out.write("    \tvar data = {\n");
      out.write("        \t\tid: 0,\n");
      out.write("        \t\tuserName: ('#inputEmail').val(),\n");
      out.write("        \t\tpassWord: ('#inputPassword').val()\n");
      out.write("        };\n");
      out.write("        \n");
      out.write("        $.post(\"/login\", data, function (response) {\n");
      out.write("        \t$('#errorMessage').html(response);\n");
      out.write("        });\n");
      out.write("    }\n");
      out.write("    </script>");
